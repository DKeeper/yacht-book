...
/**
 * This is the model class for table "cc_cancel_period".
 *
 * The followings are the available columns in table 'cc_cancel_period':
 * @property integer $id
 ...
 */
class CcCancelPeriod extends BaseModel
{
	/**
	 ...
	 * @return CcCancelPeriod the static model class
	 */
