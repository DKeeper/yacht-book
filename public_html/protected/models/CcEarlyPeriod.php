...
/**
 * This is the model class for table "cc_early_period".
 *
 * The followings are the available columns in table 'cc_early_period':
 * @property integer $id
...
class CcEarlyPeriod extends BaseModel
{
	 ...
	 * @return CcEarlyPeriod the static model class
	 */
