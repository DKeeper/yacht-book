...
/**
 * This is the model class for table "cc_long_period".
 *
 * The followings are the available columns in table 'cc_long_period':
 * @property integer $id
 ...
 */
class CcLongPeriod extends BaseModel
{
	/**
	 ...
	 * @return CcLongPeriod the static model class
	 */
