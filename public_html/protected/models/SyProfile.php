...
class SyProfile extends BaseModel
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'jib_furling_id' => Yii::t('model','Jib furling'),
			...
			'tick_cockpit' => Yii::t('model','Tick cockpit'),
			...
			'local_skipper' => Yii::t('model','Local skipper'),
			'other_details' => Yii::t('model','Other details'),
			'site_discount' => Yii::t('model','Site discount'),
			'last_cleaning_incl' => Yii::t('model','Last cleaning incl'),
			'last_cleaning_price' => Yii::t('model','Last cleaning price'),
			'last_cleaning_obl' => Yii::t('model','Last cleaning obl'),
            ...
            'last_minute' => Yii::t('model','Last minute'),
            'week_before' => Yii::t('model','Week before'),
		);
	}
