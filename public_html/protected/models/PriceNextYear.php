...
/**
 * This is the model class for table "price_next_year".
 *
 * The followings are the available columns in table 'price_next_year':
 * @property integer $id
 ...
 */
class PriceNextYear extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('date_from, date_to','default','value' => null),
	 ...
	 * @return PriceNextYear the static model class
	 */
