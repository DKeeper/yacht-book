...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.minClusterSize_ = options['minimumClusterSize'] || 2;
     ...
     * @type {*|Object}
     */
  this.anchorPoint_ = options['anchorPoint'] || {x:0,y:-20};
...
MarkerClusterer.prototype.getAnchorPoint = function() {
    return this.anchorPoint_;
}

MarkerClusterer.prototype.setAnchorPoint = function(point) {
...
function Cluster(markerClusterer) {
  ...
  this.anchorPoint_ = markerClusterer.getAnchorPoint();
  this.center_ = null;
  this.markers_ = [];
  this.bounds_ = null;
...
Cluster.prototype.getAnchorPoint = function() {
    return this.anchorPoint_;
};

Cluster.prototype.get = function(method) {
    method = "get"+method.substring(0,1).toUpperCase()+method.substring(1);
    if(typeof Cluster.prototype[method] === "function"){
        return Cluster.prototype[method].call(this);
    } else {
        throw new Error("Not found method: "+method);
    }
};
...
ClusterIcon.prototype.useStyle = function() {
  ...
  if(typeof style['url'] === "function"){
      this.url_ = style['url'].call(this);
  } else {
      this.url_ = style['url'];
  }
...
ClusterIcon.prototype.getCluster = function() {
