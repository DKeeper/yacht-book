...
/**
 * This is the model class for table "cc_order_options".
 *
 * The followings are the available columns in table 'cc_order_options':
 * @property integer $id
...
class CcOrderOptions extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, cc_profile_id, order_option_id, obligatory, included, price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('order_option_id',$this->order_option_id);
	 ...
	 * @return CcOrderOptions the static model class
	 */
