 ...
 * @property integer $stolica
 * @property string $telefon
 * @property string $pochta
 * @property integer $naselenie
 * @property integer $ploshad
 * @property string $shtih_kod
 ...
 * @property string $pre_tabl
 * @property integer $post_id
 * @property string $post_tabl
 * @property integer $sxema
 * @property integer $sxema_kontinent
 * @property integer $sxema_region
 ...
 */
class Strana extends BaseModel
{
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'post_tabl' => 'Post Tabl',
			'sxema' => 'Sxema',
			'sxema_kontinent' => 'Sxema Kontinent',
			'sxema_region' => 'Sxema Region',
	...
	public function search()
	{
		...
		$criteria->compare('iso_kod3',$this->iso_kod3,true);
		$criteria->compare('iso_kod2',$this->iso_kod2,true);
		$criteria->compare('domen',$this->domen,true);
		$criteria->compare('giddom',$this->giddom,true);
		$criteria->compare('gosyazyk',$this->gosyazyk);
		$criteria->compare('mir_id',$this->mir_id);
		$criteria->compare('obj_id',$this->obj_id);
		$criteria->compare('kontinent',$this->kontinent);
		...
		$criteria->compare('stolica',$this->stolica);
		...
		$criteria->compare('shtih_kod',$this->shtih_kod,true);
		...
		$criteria->compare('pre_tabl',$this->pre_tabl,true);
		$criteria->compare('post_id',$this->post_id);
		$criteria->compare('post_tabl',$this->post_tabl,true);
		$criteria->compare('sxema',$this->sxema);
		$criteria->compare('sxema_kontinent',$this->sxema_kontinent);
		$criteria->compare('sxema_region',$this->sxema_region);
	 ...
	 * @return Strana the static model class
	 */
